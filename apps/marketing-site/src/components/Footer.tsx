        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-secondary-400 mb-6">
              Your all-in-one business platform for growth and success.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="#apps" className="text-secondary-400 hover:text-white transition-colors">
                  Apps
                </Link>
              </li>
              <li>
                <Link href="/api" className="text-secondary-400 hover:text-white transition-colors">
                  API
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/partners" className="text-secondary-400 hover:text-white transition-colors">
                  Partners
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/status" className="text-secondary-400 hover:text-white transition-colors">
                  Status
                </Link>
              </li>
              <li>
                <Link href="/community" className="text-secondary-400 hover:text-white transition-colors">
                  Community
                </Link>
              </li>
              <li>
                <Link href="/support" className="text-secondary-400 hover:text-white transition-colors">
                  Contact Support
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-secondary-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-secondary-400 text-sm">
              © 2024 AuraTechIT. All rights reserved.
            </div>
